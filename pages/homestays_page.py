...
class HomeStayPage(BasePage):
    """Page Object for the Homestays tab on MakeMyTrip homepage."""

    TAB_CY = "menu_Homestays"
    URL_KEYWORD = "homestays"
    ...
    def get_search_form(self):
        return self.page.locator('//label[@for="city"]//span[@class="lbl_input appendBottom5"]')
    ...
    def open(self) -> None:
        """Navigate to homepage and click the Corporate Travel tab."""
