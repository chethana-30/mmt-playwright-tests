...
class HolidaysPage(BasePage):
    """Page Object for the Holidays tab on MakeMyTrip homepage."""

    TAB_CY = "menu_Holidays"
    URL_KEYWORD = "holidays"
    ...
    def get_search_form(self):
        return self.page.locator('//label[@for="fromCity"]//span[@class="appendBottom5 field-label "]')
    ...
    def open(self) -> None:
        """Navigate to homepage and click the Holidays tab."""
